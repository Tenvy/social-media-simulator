...
class MediaPost {
    ...
    addPost(newPost) {
        this.posts.push(Object.assign({}, newPost));
    }
    getPosts() {
...
form.addEventListener("submit", (e) => {
    e.preventDefault();
    const objInput = {
        profileInput: document.querySelector("#profile_input").files,
        usernameInput: document.querySelector("#username_input").value,
        postInput: document.querySelector("#post_input").files,
        descriptionInput: document.querySelector("#description_input").value,
    };
    if (objInput.profileInput &&
